...
const STYLES: Record<CompletionAlertSeverity, SeverityStyles> = {
  info: {
    ...
    confirmButtonClass: '!bg-blue-600 text-white hover:!bg-blue-700 focus-visible:ring-blue-500',
  ...
  warning: {
    ...
    confirmButtonClass: '!bg-amber-500 text-white hover:!bg-amber-600 focus-visible:ring-amber-500',
    cancelButtonClass: 'bg-gray-100 text-gray-700 hover:bg-gray-200',
  ...
  critical: {
    ...
    cancelButtonClass: 'bg-gray-200 text-gray-700 hover:bg-gray-300',
